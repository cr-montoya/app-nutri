...
- [ ] T9.3 Record the completed Neon positive and negative RLS validations in `design.md`. Validation: `pnpm test -- rls-positive && pnpm test -- rls-negative`. Closes REQ-029.
