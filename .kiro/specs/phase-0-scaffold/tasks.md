...
- [ ] T9.4 Push the approved CI changes to the feature branch and verify the Preview deployment plus DAST, SBOM, dependency review, gitleaks, and Semgrep checks through GitHub. Validation: `gh pr checks 1 --watch --interval 10`. Closes REQ-025, REQ-026, REQ-027, REQ-028.
