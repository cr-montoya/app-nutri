...
- **REQ-014**: THE SYSTEM SHALL NEVER execute a repository-controlled package lifecycle script in a migration job that receives a schema-modification credential; dependency setup for that job SHALL disable lifecycle scripts.
